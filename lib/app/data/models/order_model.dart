...
class OrderModel {
  ...
  /// Self-service cancel is only offered before admin approves the order —
  /// a customer order has no salesman review stage, so this is the whole
  /// window before packing starts.
  bool get canCancel => status == 'admin_review';
